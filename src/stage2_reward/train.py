...
def load_config(config_path: str) -> RMConfig:
    ...
    return RMConfig(
        ...
        freeze_layers_except_last_n=m.get("freeze_layers_except_last_n", RMConfig.freeze_layers_except_last_n),
        per_device_train_batch_size=t.get("per_device_train_batch_size", RMConfig.per_device_train_batch_size),
        gradient_accumulation_steps=t.get("gradient_accumulation_steps", RMConfig.gradient_accumulation_steps),
        ...
        gradient_checkpointing=t.get("gradient_checkpointing", RMConfig.gradient_checkpointing),
        min_accuracy=e.get("min_accuracy", RMConfig.min_accuracy),
        min_reward_margin_ratio=e.get("min_reward_margin_ratio", RMConfig.min_reward_margin_ratio),
        _raw_config=params,
    )
